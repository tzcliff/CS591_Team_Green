...
public class West extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        if (velocityX > 800) {
            // fling to the right
            Intent myIntent = new Intent(West.this, East.class);
            West.this.startActivity(myIntent);

        }
        else if (velocityX < -800) {
            // fling to the left
            Intent myIntent = new Intent(West.this, Home.class);
            West.this.startActivity(myIntent);

        }
        else if (velocityY > 800) {
            // fling down
            Intent myIntent = new Intent(West.this, South.class);
            West.this.startActivity(myIntent);

        }
        else if (velocityY < -800) {
            // fling up
            Intent myIntent = new Intent(West.this, North.class);
            West.this.startActivity(myIntent);
