...
public class South extends AppCompatActivity implements  GestureDetector.OnGestureListener{
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        if (velocityX > 800) {
            // fling to the right
            Intent myIntent = new Intent(South.this, East.class);
            South.this.startActivity(myIntent);

        }
        else if (velocityX < -800) {
            // fling to the left
            Intent myIntent = new Intent(South.this, West.class);
            South.this.startActivity(myIntent);

        }
        else if (velocityY > 800) {
            // fling down
            Intent myIntent = new Intent(South.this, Home.class);
            South.this.startActivity(myIntent);

        }
        else if (velocityY < -800) {
            // fling up
            Intent myIntent = new Intent(South.this, North.class);
            South.this.startActivity(myIntent);
